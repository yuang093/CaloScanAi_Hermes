        ...
        <div style={{
          ...
          {tab === 'login' ? (
            <>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                <div>
                  ...
                  <input
                    ...
                    required
                    style={{ width: '100%', padding: '14px 16px', border: '1px solid #e8e2db', borderRadius: '10px', fontSize: '15px', fontFamily: 'inherit', background: '#faf8f5', color: '#2d2a26', outline: 'none', transition: 'border-color 0.2s, box-shadow 0.2s', boxSizing: 'border-box' }}
                    onFocus={(e) => { e.target.style.borderColor = '#c97d8e'; e.target.style.boxShadow = '0 0 0 3px #f3e8ec'; }}
              ...
              <p style={{ marginTop: '20px', textAlign: 'center', fontSize: '13px', color: '#8a8279' }}>
                還沒有帳號？<Link href="/register" style={{ color: '#c97d8e', textDecoration: 'none', fontWeight: '500' }}>立即註冊</Link>
              </p>
            </>
          ) : (
            <p style={{ textAlign: 'center', color: '#8a8279', padding: '40px 0' }}>
              <Link href="/register" style={{ color: '#c97d8e', textDecoration: 'none', fontWeight: '500', fontSize: '15px' }}>前往註冊 →</Link>
            </p>
          )}
        </div>
      </div>
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '80px 56px', background: '#faf7f3', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: '28px', fontWeight: 400, marginBottom: '8px', color: '#1c1917' }}>登入帳號</h2>
        <p style={{ fontSize: '13px', color: '#6b6560', marginBottom: '36px' }}>
          還沒有帳號？<Link href="/register" style={{ color: '#c45c3a', textDecoration: 'none' }}>立即註冊</Link>
        </p>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div>
            ...
            <input
              ...
              onChange={(e) => setForm({ ...form, identifier: e.target.value })}
              required
              style={{ width: '100%', padding: '12px 14px', border: '1px solid #ddd6ce', background: '#f4efe8', color: '#1c1917', fontSize: '15px', fontFamily: 'inherit', outline: 'none', borderRadius: '2px', transition: 'border-color 0.2s', boxSizing: 'border-box' }}
              onFocus={(e) => { e.target.style.borderColor = '#c45c3a'; }}
              onBlur={(e) => { e.target.style.borderColor = '#ddd6ce'; }}
            />
          </div>
          <div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '56px 48px', background: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          <div style={{ fontSize: '28px', fontWeight: 900, marginBottom: '4px', letterSpacing: '-0.02em', color: '#1a1208' }}>開始使用</div>
          <p style={{ fontSize: '13px', color: 'rgba(26,18,8,0.5)', marginBottom: '32px' }}>
            還沒有帳號？<Link href="/register" style={{ color: '#ff6b35', fontWeight: 700, textDecoration: 'none' }}>立即註冊</Link>
          </p>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div>
              ...
              <input
                ...
                onChange={(e) => setForm({ ...form, identifier: e.target.value })}
                required
                style={{ width: '100%', padding: '12px 14px', border: '2px solid #1a1208', borderRadius: '8px', fontSize: '15px', fontFamily: 'inherit', background: '#fef9f3', color: '#1a1208', outline: 'none', boxSizing: 'border-box', boxShadow: '4px 4px 0px #1a1208' }}
                onFocus={(e) => { e.target.style.boxShadow = '6px 6px 0px #1a1208'; e.target.style.transform = 'translate(-2px, -2px)'; }}
                onBlur={(e) => { e.target.style.boxShadow = '4px 4px 0px #1a1208'; e.target.style.transform = 'none'; }}
              />
            </div>
            <div>
